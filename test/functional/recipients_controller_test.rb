...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { address: @recipient.address, email: @recipient.email, name: @recipient.name, needs: @recipient.needs, phone: @recipient.phone }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { address: @recipient.address, email: @recipient.email, name: @recipient.name, needs: @recipient.needs, phone: @recipient.phone }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
